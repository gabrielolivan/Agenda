...
<form action="{{ route('contato.endereco.update', [$contato, $endereco]) }}" method="post">
    @csrf
    @method("PATCH")
    ...
    <div class="card-body mb-3">
        ...
        <div class="card-body mb-1 border rounded">
            <x-input name="pais_endereco" id="pais_endereco" :value="old('pais_endereco', $endereco->pais)" span="País"/>
